          ...
          <div className='row membership-1st-row'>
            <div className='col-md-4'>
              <MembershipCard
                ...
                purchase='https://theulem.square.site/product/platinum-chairman-s-club/1?cs=true'
              />
            </div>
            <div className='col-md-4'>
              <MembershipCard
                ...
                purchase='https://theulem.square.site/product/gold-president-club/3?cs=true'
              />
            </div>
            <div className='col-md-4'>
              <MembershipCard
                ...
                purchase='https://theulem.square.site/product/silver-church-small-business-membership/2?cs=true'
              />
            </div>
          </div>
          <div className='row membership-2nd-row'>
            <div className='col-md-4'>
              <MembershipCard
                ...
                li7='&bull; Membership Card'
                li8='&bull; Enterprise Rent-A-Car Discount'
                purchase='https://theulem.square.site/product/bronze-heritage-club/5?cs=true'
              />
            </div>
            <div className='col-md-4'>
              <MembershipCard
                ...
                purchase='https://theulem.square.site/product/basic-legacy/6?cs=true'
              />
            </div>
            <div className='col-md-4'>
              <MembershipCard
                ...
                li2='&bull; Member listing'
                li3='&bull; ULEM newsletter'
                purchase='https://theulem.square.site/product/student-senior-member-60-/4?cs=true'
              />
            </div>
          </div>
        </div>
