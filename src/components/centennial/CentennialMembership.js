  ...
  render() {
    return (
      <div className="container text-center">
          ...
          <p><strong>CENTENNIAL MEMBERSHIP LEVELS SUPPORTS THE BUILDING OF RESERVE FUNDS AND INFRASTRUCTURE OF THE URBAN LEAGUE AND ALL OF ITS PROGRAMAS AND ALSO INCLUDE TICKETS OUR 100TH ANNIVERSARY BENEFIT CONCERT FEATURING JEFFERY OSBORNE</strong></p>
          ...
          <p><strong>All memberships are renewable annually.</strong></p>
          <p>This is a benefit concert which means that every ticket sold benefits the Urban Leage of Easten MA directly. General admission tickets begin at $35 and can be purchased at Hard Rock Rocksino in Northfield Park box office</p>
      </div>
    )
  }
}
